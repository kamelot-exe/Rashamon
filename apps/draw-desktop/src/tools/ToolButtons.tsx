/**
 * ToolButtons — minimal vertical icon-only tool selector.
 */
...
const TOOLS: ToolDef[] = [
  ...
  { type: 'hand', icon: 'M18 11V6a2 2 0 0 0-4 0v1M14 10V4a2 2 0 0 0-4 0v6M10 10V5a2 2 0 0 0-4 0v11l-1.3-2.5a2 2 0 0 0-3.4 1.9L4 22h12l2-8a2 2 0 0 0-4 0', label: 'Hand', shortcut: 'H' },
